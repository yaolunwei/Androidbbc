 ...
 */
package com.bigoat.bbc.go.cache.policy;
...
import com.bigoat.bbc.go.db.CacheManager;
import com.bigoat.bbc.go.exception.HttpException;
import com.bigoat.bbc.go.model.Response;
import com.bigoat.bbc.go.request.base.Request;
import com.bigoat.bbc.go.utils.HeaderParser;
...
public abstract class BaseCachePolicy<T> implements CachePolicy<T> {
    ...
    protected void runOnUiThread(Runnable run) {
        Go.getInstance().getDelivery().post(run);
    }
