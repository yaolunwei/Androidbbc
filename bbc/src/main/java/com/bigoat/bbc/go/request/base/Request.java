 ...
 */
package com.bigoat.bbc.go.request.base;

import android.text.TextUtils;

import com.bigoat.bbc.go.Go;
import com.bigoat.bbc.go.adapter.AdapterParam;
import com.bigoat.bbc.go.adapter.CacheCall;
import com.bigoat.bbc.go.adapter.Call;
import com.bigoat.bbc.go.adapter.CallAdapter;
import com.bigoat.bbc.go.cache.CacheEntity;
import com.bigoat.bbc.go.cache.CacheMode;
import com.bigoat.bbc.go.cache.policy.CachePolicy;
import com.bigoat.bbc.go.callback.Callback;
import com.bigoat.bbc.go.convert.Converter;
import com.bigoat.bbc.go.model.HttpHeaders;
import com.bigoat.bbc.go.model.HttpMethod;
...
public abstract class Request<T, R extends Request> implements Serializable {
    ...
    public okhttp3.Call getRawCall() {
        ...
        if (client == null) client = Go.getInstance().getOkHttpClient();
