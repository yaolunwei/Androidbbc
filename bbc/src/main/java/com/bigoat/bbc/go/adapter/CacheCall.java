 ...
 */
package com.bigoat.bbc.go.adapter;

import com.bigoat.bbc.go.cache.CacheEntity;
import com.bigoat.bbc.go.cache.policy.CachePolicy;
import com.bigoat.bbc.go.cache.policy.DefaultCachePolicy;
import com.bigoat.bbc.go.cache.policy.FirstCacheRequestPolicy;
import com.bigoat.bbc.go.cache.policy.NoCachePolicy;
import com.bigoat.bbc.go.cache.policy.NoneCacheRequestPolicy;
import com.bigoat.bbc.go.cache.policy.RequestFailedCachePolicy;
import com.bigoat.bbc.go.callback.Callback;
import com.bigoat.bbc.go.model.Response;
import com.bigoat.bbc.go.request.base.Request;
